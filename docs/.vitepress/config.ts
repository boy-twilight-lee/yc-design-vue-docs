      ...
      '/components/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '走马灯 Carousel', link: '/components/carousel/index.md' },
            {
              text: '折叠面板 Collapse',
            ...
            { text: '文字提示 Tooltip', link: '/components/tooltip/index.md' },
          ],
        },
        {
          text: '数据录入',
          items: [
            ...
            { text: '输入标签 InputTag', link: '/components/input-tag' },
            ...
            { text: '级联选择器 Cascader', link: '/components/cascader' },
